     ...
     <div class="grid grid-cols-1  lg:grid-cols-3  gap-6">
       ...
       <div class="lg:col-span-2">
         <figure>
           ...
           @else
           <img class="w-full h-72 object-cover object-center" src="https://cdn.pixabay.com/photo/2021/04/26/17/37/germany-6209610_960_720.jpg" alt="">  
           @endif
         </figure>
            ...
            <ul>
              ...
              <li class="mb-4">
                     <a class="flex" href="{{route('posts.show', $similar)}}">
                      ...
                      @else
                      <img class="w-36 h-25 object-cover object-center" src="https://cdn.pixabay.com/photo/2021/04/26/17/37/germany-6209610_960_720.jpg" alt="">
                      @endif
